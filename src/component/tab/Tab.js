var Tab = (function() {
	...
	Tab.events = {
		SELECTED : "SELECTED",
		CLOSE : "CLOSE",
		DROP_ON_CONTAINER : "DROP_ON_CONTAINER",
		DROP_ON_MODULE : "DROP_ON_MODULE"
	};
	...
	_Class.extend(Tab, UIElement, {
		...
		setListeners : function() {
			...
			this.getElement().addEventListener('drag', this.onDrag.bind(this));
		...
		onDrag : function(event) {
			...
			EventManager.data.transfer = this;
		}
	});
